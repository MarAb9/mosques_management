        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card text-white animate__animated animate__fadeInUp animate-delay-1 scroll-animate" style="background: var(--primary-gradient);">
                <div class="card-body">
                    ...
                    <div class="real-count" data-count="<?php echo $count; ?>" data-target="total-mosques" style="display:none;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card text-white animate__animated animate__fadeInUp animate-delay-2 scroll-animate" style="background: var(--success-gradient);">
                <div class="card-body">
                    ...
                    <?php
                    $stmt = $pdo->query("SELECT COUNT(*) FROM mosques WHERE friday_prayer = 'نعم'");
                    $count = $stmt->fetchColumn();
                    ?>
                    <h2 class="card-text count-up" id="friday-mosques">0</h2>
                    <div class="real-count" data-count="<?php echo $count; ?>" data-target="friday-mosques" style="display:none;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card text-white animate__animated animate__fadeInUp animate-delay-3 scroll-animate" style="background: var(--info-gradient);">
                <div class="card-body">
                    ...
                    <?php
                    $stmt = $pdo->query("SELECT COUNT(*) FROM mosques WHERE status = 'مغلق'");
                    $count = $stmt->fetchColumn();
                    ?>
                    <h2 class="card-text count-up" id="closed-mosques">0</h2>
                    <div class="real-count" data-count="<?php echo $count; ?>" data-target="closed-mosques" style="display:none;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card text-white animate__animated animate__fadeInUp animate-delay-4 scroll-animate" style="background: var(--warning-gradient);">
                <div class="card-body">
                    ...
                    <div class="real-count" data-count="<?php echo $count; ?>" data-target="prayer-mosques" style="display:none;"></div>
                </div>
            </div>
        </div>
            ...
            <a href="quran_mosques.php" style="text-decoration: none;">
                <div class="stat-card text-white animate__animated animate__fadeInUp scroll-animate" style="background: var(--lavender-gradient);">
                    <div class="card-body">
                        ...
                        <div class="real-count" data-count="<?php echo $count; ?>" data-target="quran-mosques" style="display:none;"></div>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card text-white animate__animated animate__fadeInUp scroll-animate" style="background: var(--teal-gradient);">
                <div class="card-body">
                    ...
                    <?php
                    $stmt = $pdo->query("SELECT COUNT(*) FROM mosques WHERE guidance_program = 'نعم'");
                    $count = $stmt->fetchColumn();
                    ?>
                    <h2 class="card-text count-up" id="guidance-mosques">0</h2>
                    <div class="real-count" data-count="<?php echo $count; ?>" data-target="guidance-mosques" style="display:none;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card text-white animate__animated animate__fadeInUp scroll-animate" style="background: var(--peach-gradient);">
                <div class="card-body">
                    ...
                    <?php
                    $stmt = $pdo->query("SELECT COUNT(*) FROM mosques WHERE admin_type = 'pashalik'");
                    $count = $stmt->fetchColumn();
                    ?>
                    <h2 class="card-text count-up" id="pashalik-mosques">0</h2>
                    <div class="real-count" data-count="<?php echo $count; ?>" data-target="pashalik-mosques" style="display:none;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card text-white animate__animated animate__fadeInUp scroll-animate" style="background: var(--indigo-gradient);">
                <div class="card-body">
                    ...
                    <?php
                    $stmt = $pdo->query("SELECT COUNT(*) FROM mosques WHERE admin_type = 'circle'");
                    $count = $stmt->fetchColumn();
                    ?>
                    <h2 class="card-text count-up" id="circle-mosques">0</h2>
                    <div class="real-count" data-count="<?php echo $count; ?>" data-target="circle-mosques" style="display:none;"></div>
                </div>
            </div>
        </div>
                                    ...
                                    echo "<tr class='animate__animated animate__fadeIn'>
                                        ...
                                        <td>
                                            <div class='d-flex align-items-center'>
                                                ...
                                                <div>
                                                    <div class='fw-bold'>{$row['mosque_name']}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>{$row['community']}</td>
                                        ...
                                        <td class='text-center'>
                                            <span class='badge bg-light text-dark'>{$row['construction_year_only']}</span>
                                        </td>
                                        <td class='text-center'>";
                                        
                                        if($row['friday_prayer'] == 'نعم') {
                                        ...
                                        <td>
                                            <div class='d-flex align-items-center'>
                                                ...
                                                <div>
                                                    <div class='fw-bold'>{$row['imam_name']}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
