...
?>
                                    <tr>
                                        <td>
                                            <input type="checkbox" name="selected_mosques[]" value="<?= $view->e($row['id']) ?>" class="form-check-input mosque-checkbox" aria-label="تحديد <?= $view->e($row['mosque_name']) ?>">
                                        </td>
                                        <td class="fw-bold text-muted"><?= $view->e($row['id']) ?></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <i class="fas fa-mosque text-primary me-2" aria-hidden="true"></i>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <i class="fas fa-user-tie text-info me-2" aria-hidden="true"></i>
                                                <span><?= $view->e($responsibleText ?: 'غير محدد') ?></span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="d-flex justify-content-center" data-bs-toggle="tooltip" title="<?= $row['has_accommodation'] == 'نعم' ? 'يوجد إقامة' : 'لا يوجد إقامة' ?>">
                                                <i class="fas <?= $accommodationIcon ?> fa-lg" aria-hidden="true"></i>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2" aria-label="إجراءات السجل">
                                                <a href="#"
                                                class="btn btn-sm btn-icon btn-outline-secondary view-quran-mosque-btn"
