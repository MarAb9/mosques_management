...
تحديث بتاريخ 21 يوليو 2026: تعتمد الخرائط على Leaflet وLeaflet.markercluster محلياً، مع خريطة شوارع OpenStreetMap نقطية دون مفتاح API أو وظيفة توجيه.
...
## تحسينات الاستخدام اللاحقة

أضيفت جولة تحقق مركزة بعد ملاحظات الاستخدام على تسجيل الدخول ودليل المساجد:

- استُخدمت صورة المسجد الأصلية الموجودة في `public/assets/images/1.jpg` كخلفية كاملة لصفحة الدخول، مع بطاقة واضحة على سطح المكتب والهاتف.
- أضيف خيار `نسيت كلمة المرور؟` يعرض مسار إعادة التعيين الآمن عبر المسؤول العام؛ قاعدة المستخدمين الحالية لا تحتوي بريداً إلكترونياً أو قناة إرسال تسمح باسترجاع ذاتي موثوق.
- أعيد بناء خيارات قائمة الأعمدة بعناصر مستقلة لا تتأثر بإزاحات Bootstrap الخاصة بـ RTL؛ نتيجة قياس التداخل لكل الخيارات الأربعة كانت `false`.
- أزيل زر الكثافة وسلوكه وتخزينه المحلي بالكامل.
- أصبحت مرشحات الجماعة والوضعية وصلاة الجمعة والإمام المرشد تنفذ AJAX مباشرة عند التغيير، وتحدث الجدول والبطاقات والعدد وعنوان الصفحة دون انتظار زر البحث.

| الحالة | الدليل |
|---|---|
| الدخول — سطح المكتب | [login-1440](screenshots/ui-reset-v2/after/login-1440.png) |
| الدخول — الهاتف | [login-mobile-390](screenshots/ui-reset-v2/after/login-mobile-390.png) |
| إرشادات نسيان كلمة المرور | [login-recovery-open-1440](screenshots/ui-reset-v2/after/login-recovery-open-1440.png) |
| محاذاة خيارات الأعمدة | [mosques-columns-open-1440](screenshots/ui-reset-v2/after/mosques-columns-open-1440.png) |
| تطبيق المرشح الفوري | [mosques-live-filter-1440](screenshots/ui-reset-v2/after/mosques-live-filter-1440.png) |

نتيجة التدقيق المركز: 4 حالات صفحات و3 حالات تفاعل و7 لقطات، دون فشل console أو network أو overflow. أدى اختيار جماعة مباشرة إلى تحديث العدد إلى 9 نتائج وإضافة المرشح إلى URL، وكان زر الكثافة غائباً. أعيد أيضاً تشغيل اختبارات foundation (22/0) وmosque CRUD (31/0) وHTTP smoke بنجاح.
